...
const navbar = () => {
  return (
   ...
   <div className='navbar' style={{backgroundColor:"white"}}>
    <div className='insidenav' style={{fontSize:"30px", marginLeft:"50px", marginTop:"10px", color:"black"}}> <img src={ik} alt="" width="30px" style={{borderRadius:"10px", position:"relative", right:"30px", top:"4px"}}/>Terrain Recognizer</div>
    <nav>
        <ul>
