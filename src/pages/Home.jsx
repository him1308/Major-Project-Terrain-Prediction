...
const Home = () => {
 ...
 <div>
  ...
  <div className="works">
      ...
      <p style={{position:"relative", top:"800px", left:"30px", fontSize:"25px"}}>We provide Deep learning and CNN technology to analyze terrain data. Users input relvant data, and the system autimatically processes <br /> and classifies the terrain.</p>
...
<footer style={{background:"black", border:"1px solid black", marginTop:"650px", height:"30px", color:"white", textAlign:"center",fontSize:"22px", width:"100%"}}> &copy; CopyRight Team MP_26-27, 2025.</footer>
